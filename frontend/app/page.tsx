        ...
        <section className="relative flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mx-auto mt-8 max-w-xl text-base text-muted-foreground md:text-lg">
              Every post you publish is simultaneously a beautiful article
              for people and a structured feed for AI agents.
              One write, two audiences.
            </p>
            ...
            <div className="mt-14 grid gap-px overflow-hidden rounded-xl border bg-border md:grid-cols-3">
              {[
                ...
                <div key={item.step} className="bg-background p-8 md:p-10">
                  <span className="text-3xl font-black text-muted-foreground/15">
                    {item.step}
                  </span>
        ...
        <section className="border-t">
          <div className="mx-auto max-w-5xl px-4 py-20 text-center md:py-28">
            ...
            <p className="mx-auto mt-4 max-w-xl text-muted-foreground">
              Join NowBind and publish content that works for readers and AI agents alike.
