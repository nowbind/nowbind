...
export function ShareButtons({ url, title }: ShareButtonsProps) {
  ...
  const shareReddit = () => {
    window.open(
      `https://www.reddit.com/submit?url=${encodeURIComponent(fullUrl)}&title=${encodeURIComponent(title)}`,
      "_blank",
      "noopener,noreferrer"
    );
  };
  ...
  return (
    <div className="flex items-center gap-0.5">
      ...
      <Button variant="ghost" size="icon-sm" onClick={shareReddit} className="text-muted-foreground">
        <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
