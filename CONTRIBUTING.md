...
The platform includes an automated content moderation pipeline (`moderation-service/`) for NSFW and spam detection. When changing moderation logic:

- **Thresholds**: Adjustments to detection thresholds live in `moderation-service/models/`. Lower thresholds = stricter.
